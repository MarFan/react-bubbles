...
- [ ] Explain what a token is used for. 
		- The token is for a sever to verify that a connections has been authorized and allows transactions to continue
- [ ] What steps can you take in your web apps to keep your data secure?
		- Use PrivateRoutes and verify a token is present.
- [ ] Describe how web servers work.
		- The computer or the software responding to the requests?  A webserver is just waiting for a request and upon request it response with the code that has been pushed/uploaded to the server.
